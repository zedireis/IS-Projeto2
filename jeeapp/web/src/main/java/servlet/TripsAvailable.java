...
@WebServlet("/secured/tripsavailable")
public class TripsAvailable extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(dateInicio.equals("") || dateFim.equals("") || horaFim.equals("") || horaInicio.equals("")){
            ...
            try {
                ...
                if (dateI.after(dateF)) {
                    ...
                    logger.info("A pesquisar viagens para a data: "+dateI.toString()+"->"+dateF.toString());
                    lista = ibusiness.tripsAvailables(dateI, dateF);
        ...
        request.getRequestDispatcher("/secured/AvailableTrips.jsp").include(request, response);
        out.close();
    }
